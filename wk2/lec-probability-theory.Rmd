...
```{r plot-grid-samples, fig.align='center', out.height="50%"}
ggplot() +
...
* Compute intervals from boundaries (e.g. > .50)
...
```{r plot-bounded-interval, fig.align='center', out.height="50%"}
ggplot() +
...
```{r plot-cred-interval, fig.align='center', out.height="30%"}
...
```{r plot-hpdi-interval, fig.align='center', out.height="30%"}
...
```{r moral-milg-prior-fig, out.height="40%", fig.align='center'}
tibble(
...
```{r moral-milg-post-fig, out.height="40%", fig.align='center'}
# tibble(
#   p_grid = seq(0, 1, length.out=1e3),
...
What do we think the difference in Jevon's success rates are when there are four beans compared with when there are five? i.e. what is $\pi_4 - \pi_5$?
